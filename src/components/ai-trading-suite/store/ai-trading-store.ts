...
const NOTIFICATION_TEMPLATES: { type: TAiNotification['type']; title: string; message: string }[] = [
    { type: 'OPPORTUNITY', title: '🎯 High Probability Opportunity', message: 'New high-confidence setup detected across synthetic indices.' },
    { type: 'STRATEGY_INJECTED', title: '✅ Strategy Deployed', message: 'AI strategy parameters successfully injected into Bot Builder.' },
    { type: 'SYNC_ENABLED', title: '🔗 Trade Sync Active', message: 'Copy trade synchronization established with selected trader.' },
    { type: 'VOLATILITY_SPIKE', title: '⚡ Volatility Spike', message: 'Abnormal volatility detected — monitor positions closely.' },
    { type: 'MOMENTUM_SHIFT', title: '📈 Momentum Shift', message: 'Market momentum transitioning — new trend forming.' },
    { type: 'DIGIT_PATTERN', title: '🔢 Digit Pattern Change', message: 'Statistical digit pattern shift detected in active markets.' },
    { type: 'CONFIDENCE_UP', title: '📊 AI Confidence Increased', message: 'Signal quality improving — confidence index elevated.' },
    { type: 'SIGNAL_INVALID', title: '⚠️ Signal Invalidated', message: 'Previous signal conditions no longer valid — awaiting new setup.' },
    { type: 'MARKET_COOLING', title: '❄️ Market Cooling', message: 'Activity decreasing — standby mode recommended.' },
    { type: 'EXECUTION_READY', title: '🚀 Execution Ready', message: 'All conditions met — strategy cleared for execution.' },
];
...
const INITIAL_COPY_TRADERS: TCopyTrader[] = [
    {
        id: 'ct1', name: 'Alpha Scalper v4', style: 'High-Frequency Digit Scalping',
        winRate: 78.4, monthlyReturn: 23.7, totalProfit: 184320, drawdown: 8.2,
        riskScore: 'MEDIUM', followers: 2847, avgTradeDuration: '2–5 ticks',
        preferredMarkets: ['Volatility 10 (1s)', 'Volatility 25'],
        currentStatus: 'Actively Trading', isConnected: false, connectionHealth: 99,
        latency: 12, syncStatus: 'STANDBY', badge: '🏆 Elite',
        avatarInitials: 'AS', avatarColor: '#6C5CE7',
    },
    {
        id: 'ct2', name: 'Quantum Digit Master', style: 'Statistical Arbitrage',
        winRate: 82.1, monthlyReturn: 31.2, totalProfit: 342100, drawdown: 5.9,
        riskScore: 'LOW', followers: 5613, avgTradeDuration: '10–30 ticks',
        preferredMarkets: ['Volatility 50', 'Volatility 75'],
        currentStatus: 'Scanning Markets', isConnected: false, connectionHealth: 97,
        latency: 8, syncStatus: 'STANDBY', badge: '⭐ Verified',
        avatarInitials: 'QM', avatarColor: '#00B894',
    },
    {
        id: 'ct3', name: 'Elite Momentum Pro', style: 'Trend Following',
        winRate: 74.6, monthlyReturn: 18.4, totalProfit: 97580, drawdown: 11.3,
        riskScore: 'MEDIUM', followers: 1902, avgTradeDuration: '1–3 minutes',
        preferredMarkets: ['Volatility 100', 'Boom 300'],
        currentStatus: 'In Position', isConnected: false, connectionHealth: 94,
        latency: 21, syncStatus: 'STANDBY', badge: '🔥 Rising',
        avatarInitials: 'EM', avatarColor: '#E17055',
    },
    {
        id: 'ct4', name: 'Synthetic Precision AI', style: 'AI-Driven Pattern Recognition',
        winRate: 88.3, monthlyReturn: 42.1, totalProfit: 891200, drawdown: 3.1,
        riskScore: 'LOW', followers: 12047, avgTradeDuration: '5–15 ticks',
        preferredMarkets: ['Step Index', 'Synthetic FX EUR/USD'],
        currentStatus: 'Optimizing Parameters', isConnected: false, connectionHealth: 100,
        latency: 5, syncStatus: 'STANDBY', badge: '🤖 AI Pro',
        avatarInitials: 'SP', avatarColor: '#0984E3',
    },
    {
        id: 'ct5', name: 'Institutional Index Hunter', style: 'Volume Profile & Index Correlation',
        winRate: 71.9, monthlyReturn: 15.8, totalProfit: 62400, drawdown: 14.7,
        riskScore: 'HIGH', followers: 743, avgTradeDuration: '30 ticks – 5 minutes',
        preferredMarkets: ['Crash 300', 'Volatility 100'],
        currentStatus: 'Awaiting Setup', isConnected: false, connectionHealth: 88,
        latency: 34, syncStatus: 'STANDBY', badge: '📈 Institutional',
        avatarInitials: 'IH', avatarColor: '#FDCB6E',
    },
];

const AI_STRATEGIES: TAiStrategy[] = [
    {
        id: 's1', name: 'Digit Precision Loop v3',
        description: 'High-frequency digit prediction exploiting statistical imbalances in tick distributions.',
        difficulty: 'INTERMEDIATE', successRate: 79.4, recommendedCapital: 500,
        marketCompatibility: ['Volatility 10 (1s)', 'Volatility 25'],
        riskLevel: 'MEDIUM', expectedFrequency: '15–30 trades/hour',
        aiRating: 8.7, deploymentCount: 14820, lastUpdated: '2 days ago', estimatedAccuracy: 81.2,
    },
    {
        id: 's2', name: 'Momentum Surge Capture',
        description: 'Identifies and rides momentum breakouts following compression phases.',
        difficulty: 'ADVANCED', successRate: 83.1, recommendedCapital: 1000,
        marketCompatibility: ['Volatility 75', 'Volatility 100'],
        riskLevel: 'HIGH', expectedFrequency: '5–10 trades/hour',
        aiRating: 9.2, deploymentCount: 8340, lastUpdated: '1 day ago', estimatedAccuracy: 77.8,
    },
    {
        id: 's3', name: 'Even-Odd Arbitrage Matrix',
        description: 'Exploits even/odd digit distribution imbalances with multi-entry confirmation logic.',
        difficulty: 'BEGINNER', successRate: 68.9, recommendedCapital: 200,
        marketCompatibility: ['Volatility 10 (1s)', 'Volatility 50', 'Step Index'],
        riskLevel: 'LOW', expectedFrequency: '20–40 trades/hour',
        aiRating: 7.4, deploymentCount: 31200, lastUpdated: '5 hours ago', estimatedAccuracy: 71.3,
    },
    {
        id: 's4', name: 'Entropy Collapse Sniper',
        description: 'Detects tick entropy collapse events — high-precision entry at structural turning points.',
        difficulty: 'EXPERT', successRate: 91.2, recommendedCapital: 5000,
        marketCompatibility: ['Step Index', 'Synthetic FX EUR/USD'],
        riskLevel: 'MEDIUM', expectedFrequency: '2–5 trades/hour',
        aiRating: 9.8, deploymentCount: 2108, lastUpdated: '12 hours ago', estimatedAccuracy: 89.4,
    },
    {
        id: 's5', name: 'Volatility Asymmetry Play',
        description: 'Identifies asymmetric volatility conditions and exploits directional bias.',
        difficulty: 'ADVANCED', successRate: 76.3, recommendedCapital: 2000,
        marketCompatibility: ['Boom 300', 'Crash 300', 'Volatility 100'],
        riskLevel: 'HIGH', expectedFrequency: '8–15 trades/hour',
        aiRating: 8.1, deploymentCount: 5670, lastUpdated: '3 days ago', estimatedAccuracy: 74.9,
    },
    {
        id: 's6', name: 'Micro-Trend Continuation Alpha',
        description: 'Identifies and trades micro-trends with AI-confirmed momentum persistence signals.',
        difficulty: 'INTERMEDIATE', successRate: 72.8, recommendedCapital: 750,
        marketCompatibility: ['Volatility 25', 'Volatility 50', 'Volatility 75'],
        riskLevel: 'MEDIUM', expectedFrequency: '10–20 trades/hour',
        aiRating: 8.4, deploymentCount: 18920, lastUpdated: '6 hours ago', estimatedAccuracy: 75.1,
    },
];
...
export class AiTradingStore {
    ...
    analytics: Map<string, TMarketAnalytics> = new Map(
        BASE_ASSETS.map(a => [a.id, buildAnalytics(a.id)])
    );
    ...
    private _tickAssets = action(() => {
        this.assets = this.assets.map(asset => {
            ...
            return {
                ...
                opportunityRating: parseFloat(Math.min(9.9, Math.max(4.5, asset.opportunityRating + rand(-0.3, 0.3))).toFixed(1)),
                signalFreshness: Math.random() > 0.8 ? pick(['FRESH', 'RECENT', 'AGING'] as const) : asset.signalFreshness,
    ...
    private _tickAnalytics = action(() => {
        ...
        this.analytics.forEach((v, k) => {
            newMap.set(k, {
                ...
                volatilityMomentum: parseFloat(Math.min(99, Math.max(1, v.volatilityMomentum + rand(-3, 3))).toFixed(1)),
                evenOddBalance: parseFloat(Math.min(75, Math.max(25, v.evenOddBalance + rand(-1.5, 1.5))).toFixed(1)),
                overUnderProbability: parseFloat(Math.min(75, Math.max(25, v.overUnderProbability + rand(-1.5, 1.5))).toFixed(1)),
    ...
    setAssistantOpen(open: boolean) { this.isAssistantOpen = open; }
    toggleAssistant() { this.isAssistantOpen = !this.isAssistantOpen; }
    setActiveTab(tab: string) { this.activeTab = tab; }
    setSelectedAnalyticsAsset(id: string) { this.selectedAnalyticsAsset = id; }
    setInjectedAsset(id: string | null) { this.injectedAssetId = id; }
